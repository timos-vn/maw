...
import 'package:maw/screen/point/history_point/history_point_event.dart';

import '../../../themes/colors.dart';
import '../../../utils/const.dart';
import '../../../widgets/custom_appbar.dart';
import 'history_point_bloc.dart';
...
class HistoryPointScreen extends StatefulWidget {
  ...
  @override
  _HistoryPointScreenState createState() => _HistoryPointScreenState();
}

class _HistoryPointScreenState extends State<HistoryPointScreen>with SingleTickerProviderStateMixin{

  late HistoryPointBloc _bloc;
  ...
  Widget build(BuildContext context) {
    return BlocListener<HistoryPointBloc,HistoryPointState>(
      ...
      bloc: _bloc,
      child: BlocBuilder<HistoryPointBloc,HistoryPointState>(
        bloc: _bloc,
        builder: (BuildContext context,HistoryPointState state){
            ...
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(child: Text('Tích điểm',style: TextStyle(color: _bloc.valueChange == 0 ?  Colors.white : Colors.black),)),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(child: Text('Tiêu điểm',style: TextStyle(color: _bloc.valueChange == 1 ?  Colors.white : Colors.black),)),
                ),
              ),
            ],
          ),
