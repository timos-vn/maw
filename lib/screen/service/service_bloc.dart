...
class ServiceBloc extends Bloc<ServiceEvent,ServiceState>{
  ...
  List<String> listTabService = ["Đang sự dụng", "Chưa sử dụng",'Hết hạn'];
  ...
  void _changePageView(ChangePageViewEvent event, Emitter<ServiceState> emitter){
    emitter(InitialServiceState());
